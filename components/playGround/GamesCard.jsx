          ...
          >
            <div key={index} className="card  book">
              <div className="card-body">
                <div
                  className="clearfix fxt"
                  style={{ float: locale === "ar" && "left" }}
                >
                    ...
                    <span>
                      {item.my_game_images && (
                        <img
                          ...
                          alt="image"
                          className={
                            locale === "en" ? "book-img" : "book-img_ar"
                          }
                        ></img>
                      )}
                      {item.game_images && (
                ...
                <div
                  className={
                    locale === "en" ? "book-content" : "book-content_ar"
                  }
                >
                  ...
                  <div className="book-details">
                    ...
                    <p
                      className="book-time-date"
                      style={{
                        direction: locale === "ar" ? "ltr" : "",
                        textAlign: locale === "ar" ? "right" : "",
                      }}
                    >
                      {moment(
