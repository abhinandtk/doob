...
function MatchTimerTimeLine({ match }) {
  const startDate = moment(match.date, "YYYY-MM-DD");
  const startTime = moment(match.time, "HH:mm:ss");
...
export default MatchTimerTimeLine;
