    ...
    <div className="col-md-5 ">
      <div className=" justify-content-between align-items-center ">
        ...
        <p style={{ fontSize: "14px", fontWeight: "400" }}>
          ...
          quam rutrum metus. Et lacus, maecenas vel et arcu ut adipiscing morbi
          eget.{" "}
        </p>

        <h6>
          Color<br></br>
          <i className="bi bi-circle-fill" style={{ color: "#ED4B4B" }}></i>
          <span>
            <i
              className="bi bi-circle-fill mx-2"
              style={{ color: "purple" }}
            ></i>
            <i className="bi bi-circle-fill " style={{ color: "violet" }}></i>
          </span>
        </h6>
        ...
        <p style={{ color: "gray", fontWeight: "400" }}>
          ...
          <span
            className="mx-2"
            style={{ fontSize: "20px", fontWeight: "500", color: "#17a803" }}
          >
            13.000 KD
          </span>
          <span></span>
        ...
        <div className="qty">
          <div className="minus " style={{ backgroundColor: "#aba4a4" }}>
            -
          </div>
          <input type="number" className="count" name="qty" value="1" />
          <div className="plus " style={{ backgroundColor: "#aba4a4" }}>
            +
          </div>
        </div>
