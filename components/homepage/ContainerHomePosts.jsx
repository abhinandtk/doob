          ...
          <div className="post__profile">
            ...
            <div className="users">
              <div className="post__likes">
                <a  className="post__user">{item.user_detail.name}{item.user_detail.account_type === 'star' ?<span><img src='../images/star.png' className='mx-1 mb-1'></img></span>:''}</a>
              </div>
          ...
          <div className="post__profile">
            ...
            <div className="users">
              ...
              <div className="post__user">
                ...
                style={{textDecoration:'none'}}>
                {item.user_detail.name}{item.user_detail.account_type === 'star' ?<span><img src='../images/star.png' className='mx-1 mb-1'></img></span>:''}
                </Link>
                <span className='mx-1' style={{color:'#616661'}}>Shared</span>
                <Link href={
                  constants.user_id === item.owner_user_detail.user_detail.id ? 
                  'profile':
                  `/userprofile/${item.owner_user_detail.user_detail.id}`
                }
                style={{textDecoration:'none'}}>
                {item.owner_user_detail.user_detail.name}{item.owner_user_detail.user_detail.account_type === 'star' ?<span><img src='../images/star.png' className='mx-1 mb-1'></img></span>:''}
                </Link> 
                &nbsp;Post
                </div>
              </div>
        ...
        <div className="post__footer">
          ...
          <div className="post__infos">
            <div className="post__likes">
              ...
              <h6 style={{fontWeight:'600'}}>{item.totalLike} likes</h6>
            </div>
...
<path d="M4.04074 11.9821C3.0321 11.5114 3.15432 10.1331 4.23215 9.82356L23.9935 4.14849C24.9526 3.87306 25.851 4.71151 25.5559 5.60667L19.4755 24.0506C19.1438 25.0566 17.667 25.1707 17.1627 24.2293L12.975 16.4123C12.8541 16.1866 12.6579 16.0035 12.416 15.8906L4.04074 11.9821Z" stroke="black" stroke-width="1.50701" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <nav className="navbar1" style={{backgroundColor:'rgba(255, 255, 255, 1)',position:'sticky',bottom:'0',marginTop:'4px'}} >
      <a href="#" className="navbar__button1">
