                  ...
                  <Offcanvas.Body className="mx-4">
                    <div className="">
                      ...
                      >
                        ...
                        <span className="mx-2 hubs"> {t("Wallet")}</span>
                      </Link>
                    </div>
                    ...
                    <div className="my-4">
                      ...
                      >
                        ...
                        <span className="mx-3 hubs">{t("My Orders")}</span>
                      </Link>
                    </div>
                    ...
                    <div className="my-4">
                      ...
                      >
                        ...
                        <span className="mx-3 hubs">{t("Feedback")}</span>
                      </Link>
                    </div>
                    <div className="my-4">
                      <Link
                      ...
                      >
                        ...
                        <span className="mx-3 hubs">{t("Settings")}</span>
                      </Link>
                    </div>
                    ...
                    >
                      ...
                      &nbsp;
                      <span className="mx-3 hubs">{t("Logout")}</span>
                    </div>
                  </Offcanvas.Body>
                </Offcanvas>
              </Nav.Link>
