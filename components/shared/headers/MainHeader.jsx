                  ...
                  <Offcanvas.Body className="mx-4">
                    ...
                    <div className="my-4">
                      ...
                      >
                        ...
                        <span className="mx-2 hubs"> {t("Favourite Stores")}</span>
                      </Link>
                    </div>
                    {((user && user === "Store") ||
                      (user && user === "Pro")) && (
                      <div className="my-4">
                        ...
                        >
                          ...
                          <span className="mx-2 hubs"> {t("Manage Store")}</span>
                        </Link>
                      </div>
                    )}
                    {((user && user === "Field") ||
                      ...
                      <div className="my-4">
                        ...
                        >
                          ...
                          <span className="mx-2 hubs"> {t("Manage Field")}</span>
                        </Link>
                      </div>
                    )}
                    <div className="my-4">
                      ...
                      >
                        ...
                        <span className="mx-2 hubs"> {t("Favourite Product")}</span>
                      </Link>
                    </div>
