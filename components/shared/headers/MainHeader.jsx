            ...
            <Nav className=" ms-auto" aria-controls="responsive-navbar-nav">
              ...
              <Nav.Link onClick={() => navigationHandler("/chat/messages")}>
                <div style={{ paddingTop: "5px" }}>
                  ...
                  >
                    <path
                      d="M1 20L2.51549 15.3748C1.20569 13.4041 0.731868 11.0704 1.18211 8.80748C1.63236 6.54457 2.97604 4.50652 4.96331 3.07225C6.95059 1.63798 9.44623 0.905093 11.9862 1.00986C14.5262 1.11463 16.9377 2.04992 18.7723 3.64184C20.607 5.23375 21.7399 7.37396 21.9604 9.66453C22.181 11.9551 21.4742 14.2402 19.9714 16.0949C18.4687 17.9495 16.2722 19.2477 13.7905 19.7478C11.3087 20.248 8.71057 19.9162 6.47907 18.8141L1 20Z"
                      stroke={svgStroke}
                      stroke-width="1.4"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M10.7568 8.29412L6 13L10.1622 10.6471L12.5405 13L17 8L13.1351 10.3529L10.7568 8.29412Z"
                      stroke={svgStroke}
                      stroke-width="0.7"
                    />
                  </svg>
